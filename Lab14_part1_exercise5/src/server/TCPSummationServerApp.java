	...
	public static void main(String[] args) {
		...
		try {
			...
			while (true) {
				...
				// Further processing
				int totalSum = calculator.getSum(number1, number2, number3);
				int totalMultiplication = calculator.getMultiplication(number1, number2, number3);
				...
				System.out.println("\n\tTo client summation of the numbers: " + totalSum);
				System.out.println("\tTo client multiplication of the numbers: " + totalMultiplication);
				// To client: 2101
